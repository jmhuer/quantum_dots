...
(some info about regression vs classifcastion?)
...
capturing a wide variety of data feature by hyper-parameters [13, 2]. 
The classical GP model can be only used to deal with a single output or single response problem however there are various ways to apply gaussian process regression with multiple response variables (cite)
